...
//      _displayErrorToast(context, "Invalid email");// , "The email you entered is not valid.");
//    else if (exceptionStr == 'ERROR_USER_DISABLED')
//      _displayErrorToast(context, 'Account disabled');// , 'Your account has been disabled');
//    else if (exceptionStr == 'ERROR_USER_NOT_FOUND')
//      _displayErrorToast(context, 'Account not found'); // , 'You haven\'t created an account yet.');
//    else if (exceptionStr == 'ERROR_WRONG_PASSWORD')
//      _displayErrorToast(context, 'Password Incorrect'); // , 'You have entered an incorrect password');
//  }
